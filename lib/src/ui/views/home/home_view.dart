...
import 'package:chatterhub/src/ui/views/home/home_view_model.dart';
import 'package:chatterhub/src/ui/widgets/post_item.dart';
...
class HomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<HomeViewModel>.reactive(
      ...
      onModelReady: (model) =>
          Future.delayed(Duration.zero, () => model.listenToPosts()),
